...
export default {
    ...
    methods:{
        getRequestData(){
            axios.get('http://213.166.81.7:1337/api/orders/' +  localStorage.getItem('orderId') + '/detail/',
            {
                headers:{
        ...
        getShippingTypes(){
            axios.get('http://213.166.81.7:1337/api/shipping_types/',
            {
                headers:{
                    Authorization: 'Token ' + localStorage.getItem('usertoken')
                }
        ...
        patchRequest(){
            ...
            if(!this.$v.requestForm.$invalid){
                axios.put('http://213.166.81.7/api/orders/' + localStorage.getItem('orderId') +'/', 
                {
        ...
        deleteGood(value){
            axios.delete('http://213.166.81.7/api/order/' + this.request.id + '/good/' + value + '/good_to_send/delete', 
            {
                headers:{
                   Authorization: 'Token ' + localStorage.getItem('usertoken')
                }
        ...
        sendOrder(){
            axios.patch('http://213.166.81.7/api/orders/'+ localStorage.getItem('orderId') +'/immutable/',
            {
        ...
        generateBarCode(){
            axios.put('http://213.166.81.7/api/orders/' + localStorage.getItem('orderId') + '/barcode/generate/',
            {
        ...
        getOrderStatuses(){
            axios.get('http://213.166.81.7:1337/api/order_statuses/',
            {
                headers:{
                    Authorization: 'Token ' + localStorage.getItem('usertoken')
                }
        ...
        sendBox(){
            ...
            if(!this.$v.box.$invalid){
                axios.post('http://213.166.81.7:1337/api/packages/',
                {
        ...
        sendStatus(){
            ...
            if(!this.$v.cellstatus.$invalid){
                axios.put('http://213.166.81.7:1337/api/orders/' + localStorage.getItem('orderId') + '/fulfillment/update/',
                {
